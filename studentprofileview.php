...
if (isset($_SESSION['sserl'])) {
	$erl = $_SESSION['sserl'];
	$sel = "select * from student where enrollid='$erl'";
	$res = mysqli_query($con, $sel);
} else {
	header("location:studentlogin.php");
}
if (isset($_POST['logout'])) {
	unset($_SESSION['sserl']);
  ...
  <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
		...
		<div class="main" style="padding:100px;">
			...
			<div class="container-fluid" style="  height:100px; width:100%">
				<center>
					<h1 style="font-family: 'Aclonica';font-weight:26000; font-size:32px; color:#800000; padding-top:5px;">STUDENT DETAILS</h1>
				</center>
			</div>
				...
				<div class="col-sm-3">
						<a href="studentedit.php?sid=<?php echo $rr['sid']; ?>"><button type="submit" class="btn btn-warning" style="float:right; font-size:24px; border:solid #FFFFFF;">Edit Profile</button></a><br/><br/><br/>
						</div>
					 	</div>
					</div>

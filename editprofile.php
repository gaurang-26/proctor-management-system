					...
					<tr>
											...
											<td>
												...
												<table border="1" class="text-center" style="margin-left:403px;">
													...
													<tr>
														<th>subject1</th>
														<td><input type="text" class="form-control" id="SUBJECT1" name="SUB1" placeholder="<?php echo $subject1;?>" style="width:100%;" /></td>
													</tr>
													<tr>
														<th>subject2</th>
														<td><input type="text" class="form-control" id="SUBJECT2" name="SUB2" placeholder="<?php echo $subject2;?>" style="width:100%;" /></td>
													</tr>
													<tr>
														<th>subject3</th>
														<td><input type="text" class="form-control" id="SUBJECT3" name="SUB3" placeholder="<?php echo $subject3;?>" style="width:100%;" /></td>
													</tr>
													<tr>
														<th>subject4</th>
														<td><input type="text" class="form-control" id="SUBJECT4" name="SUB4" placeholder="<?php echo $subject4;?>"style="width:100%;" /></td>
													</tr>
													<tr>
														<th>subject5</th>
														<td><input type="text" class="form-control" id="SUBJECT5" name="SUB5" placeholder="<?php echo $subject5;?>" style="width:100%;" /></td>
													</tr>
													<tr>
														<th>subject6</th>
														<td><input type="text" class="form-control" id="SUBJECT6" name="SUB6" placeholder="<?php echo $subject6;?>"style="width:100%;" /></td>
													</tr>
												...
												<table border="1" class="text-center" style="margin-left:403px;">
													<div class="form-group">
														<label for="comment">Issues:</label>
																<textarea class="form-control" rows="5" placeholder="<?php echo $issues;?>" name="issues" id="comment"><?php echo $issues;?></textarea>
													</div>
